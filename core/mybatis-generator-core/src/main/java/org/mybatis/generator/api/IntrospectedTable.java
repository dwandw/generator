...
public abstract class IntrospectedTable {
    ...
    protected void calculateModelAttributes() {
        ...
        sb.setLength(0);
        sb.append(context.getIntrospectedCriteria().calculateJavaCriteriaPackage());
        sb.append('.');
        sb.append(fullyQualifiedTable.getDomainObjectName());
    ...
    public String getCreateTime() {
        return internalAttributes.get(InternalAttribute.ATTR_CREATE_TIME);
    }

    public void setCreateTime(String exampleType) {
        internalAttributes.put(InternalAttribute.ATTR_CREATE_TIME, exampleType);
    }
