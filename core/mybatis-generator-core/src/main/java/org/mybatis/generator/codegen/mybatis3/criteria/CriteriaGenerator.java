...
public class CriteriaGenerator extends AbstractJavaGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        FullyQualifiedJavaType type = new FullyQualifiedJavaType(introspectedCriteria.getCriteriaType());
        ...
        topLevelClass.addImportedType(new FullyQualifiedJavaType(introspectedCriteria.getCriterionType()));
        ...
        for (IntrospectedColumn introspectedColumn : introspectedTable.getNonBLOBColumns()) {
            if (stringHasValue(introspectedColumn.getTypeHandler())) {
                String name = addtypeHandledObjectsAndMethods(introspectedColumn, method, topLevelClass);
